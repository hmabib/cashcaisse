...
const DEFAULT_USERS = [
  ...
  {
    email: 'polivone.kange@pak.cm',
    first_name: 'Polivone',
    last_name: 'Kange',
    role: 'Regisseur - Full Access',
    password: 'polivone'
  },
  {
    email: 'sandrine.banini@pak.cm',
    first_name: 'Sandrine',
    last_name: 'Banini',
    role: 'Controleur',
    password: 'sandrine'
...
const normalizedConnectionString = process.env.DATABASE_URL.replace(/[?&]sslmode=[^&]+/g, '').replace(/\?$/, '');
